    ...
    <nav class="flex-1 space-y-6 overflow-y-auto px-3 py-4 scrollbar-dark">
        ...
        <div>
            ...
            <div class="space-y-1">
                ...
                <a href="{{ route('admin.mail.edit') }}" class="{{ $navLinkClasses(request()->routeIs('admin.mail.*')) }}">{{ __('Correo') }}</a>
                <a href="{{ route('admin.turnstile.edit') }}" class="{{ $navLinkClasses(request()->routeIs('admin.turnstile.*')) }}">{{ __('Cloudflare Turnstile') }}</a>
                <a href="{{ route('admin.telegram.edit') }}" class="{{ $navLinkClasses(request()->routeIs('admin.telegram.*')) }}">{{ __('Notificaciones Telegram') }}</a>
